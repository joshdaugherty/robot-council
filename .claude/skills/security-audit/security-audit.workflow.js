...
function synthPrompt(reviewed) {
  return `You are the security lead compiling the FINAL audit report for \`joshdaugherty/robot-council\`, a Laravel package (PHP 8.4, Laravel 12-13) installed into consuming applications.
